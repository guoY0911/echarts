        ...
        scroNum: function(options){
            ...
            $num_item.each(function(i, item) {
                setTimeout(function(){
                       ...
                       var randkey=Math.round(Math.random()*10)%4;
                    randkey=randkey*30
                    // console.log(-parseInt(numberArr[i])*h - h*10 + 'px');
                    var toppx=-parseInt(numberArr[i])*h - h*10+options.height-randkey;
                    if (toppx>=0) {toppx=-30}

                    $num_item.eq(i).css('top',toppx + 'px');
                },i*100)
            });
        }
    }
